...
- acceptance Markdown: สถานะ, handoff, root cause, audit accuracy และ validation summary
- `evidence/`: R7 evidence ที่คง identity, identity comparison, strict UTF-8 validation และ negative-fixture result
- `renders/`: page PNGs และ contact sheets ที่คง byte-identical กับ R7
- `SHA256SUMS.txt`: checksum ของทุกไฟล์ใน packet ยกเว้นไฟล์ checksum เอง
