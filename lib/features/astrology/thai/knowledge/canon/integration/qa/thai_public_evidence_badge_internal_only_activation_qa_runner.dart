...
/// Runs formal internal-only activation QA across deterministic fixtures.
abstract final class ThaiPublicEvidenceBadgeInternalOnlyActivationQaRunner {
  static Future<ThaiPublicEvidenceBadgeInternalOnlyActivationQaAudit> run({
    ...
    final results = <ThaiPublicEvidenceBadgeInternalOnlyActivationFixtureQaResult>[];
    var totalEligible = 0;
    ...
    for (final fixture in fixtureList) {
      ...
      final result =
          ThaiPublicEvidenceBadgeInternalOnlyActivationQaValidator.auditFixture(
    ...
    return ThaiPublicEvidenceBadgeInternalOnlyActivationQaAudit(
      fixtureResults: results,
      activationStatePassed: activationOk,
      audienceIsolationPassed: audienceOk,
      invitedBetaInactive: invitedInactive,
