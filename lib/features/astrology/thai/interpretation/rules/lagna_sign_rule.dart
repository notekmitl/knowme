...
/// Emits one core [LAGNA_SIGN_IS] fact per lagna sign signal.
final class LagnaSignRule implements ThaiMeaningRule {
  const LagnaSignRule();

  static const _signalIdPrefix = 'lagna_sign_';

  @override
  String get ruleId => ThaiInterpretationContract.lagnaSignRuleId;

  @override
  String get ruleVersion => ThaiMeaningRuleSupport.ruleVersion;

  @override
  ThaiSignalFactType get appliesTo => ThaiSignalFactType.lagnaSign;

  @override
  ThaiMeaningPredicate get predicate => ThaiMeaningPredicate.lagnaSignIs;
