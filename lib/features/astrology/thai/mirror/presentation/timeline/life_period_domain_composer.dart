...
abstract final class LifePeriodDomainComposer {
  ...
  static String _work(
    ...
    if (strength == _Band.strong) {
      return 'ดวงชี้ว่าใน${data.phaseName} งานมีแนวโน้มขยายตัวและอาจมีบทบาทใหม่เข้ามา '
          'ผลงานมีโอกาสถูกมองเห็นชัดขึ้น แต่ควรเลือกงานสำคัญแทนการรับทุกอย่างพร้อมกัน';
    }
    if (strength == _Band.active) {
      return 'ใน${data.phaseName} งานมีแนวโน้มเดินหน้าได้ต่อเนื่องและมั่นคงขึ้น '
          'ความสำเร็จมาจากการทำของเดิมให้ชัดและเสร็จ มากกว่าการเปลี่ยนทิศบ่อย';
    }
    return 'ใน${data.phaseName} งานอาจช้ากว่าที่คาดและควรแก้ข้อจำกัดเดิมก่อน '
  ...
  static String _money(
    ...
    if (strength == _Band.strong && career == _Band.strong) {
      return 'ดวงชี้ว่าใน${data.phaseName} รายได้มีโอกาสเพิ่มตามงานและหน้าที่ที่ขยายขึ้น '
          'หากเงินเข้ามากขึ้น ควรกันส่วนหนึ่งไว้รับต้นทุนและภาระที่ตามมา';
    }
    if (strength == _Band.strong) {
      return 'ใน${data.phaseName} ฐานะมีแนวโน้มตั้งหลักได้ดีขึ้นเมื่อจัดเงินเป็นระบบ '
          'เหมาะกับการสะสมและลดหนี้ มากกว่าทุ่มเงินก้อนเดียวกับความเสี่ยงสูง';
    }
    if (pressure == _Band.strong) {
      return 'ใน${data.phaseName} เงินมีแนวโน้มถูกใช้กับภาระมากกว่าการขยายทรัพย์ '
          'ต้องรักษาสภาพคล่องและหลีกเลี่ยงข้อผูกมัดระยะยาวที่เกินกำลัง';
    }
    return 'ใน${data.phaseName} การเงินมีแนวโน้มพอเดินได้แต่ยังไม่เด่น '
  ...
  static String _love(
    ...
    if (strength == _Band.strong) {
      return 'ดวงชี้ว่าใน${data.phaseName} ความสัมพันธ์มีแนวโน้มชัดขึ้นจากการกระทำที่สม่ำเสมอ '
          'ส่วนเรื่องที่ค้างคาอาจต้องคุยให้ชัดก่อนตัดสินใจ';
    }
    if (pressure == _Band.strong) {
      return 'ใน${data.phaseName} ภาระ เวลา และความคาดหวังอาจกดดันความรัก '
          'ความสัมพันธ์ที่ไม่พูดกันตรง ๆ มีโอกาสห่าง แต่การร่วมมือกันช่วยลดแรงกดดันได้';
    }
    return 'ใน${data.phaseName} ความสัมพันธ์มีแนวโน้มค่อย ๆ พัฒนา ไม่ใช่จังหวะเร่งคำตอบ '
        'ความสม่ำเสมอและการเคารพพื้นที่กันมีน้ำหนักมากกว่าความสัมพันธ์ที่มาเร็วไปเร็ว';
  }
  ...
  static String _health(
    ...
    final body = past
        ...
        : pressure == _Band.strong
        ? 'ดวงชี้ว่าใน${data.phaseName} ภาระมีแนวโน้มใช้พลังมาก ควรจัดเวลานอนและพักก่อนความล้าสะสม'
        : strength == _Band.strong
        ? 'ใน${data.phaseName} พลังชีวิตมีแนวโน้มรับมือกิจกรรมได้ดี หากรักษาการนอนและไม่ทำงานต่อเนื่องเกินไป'
        : 'ใน${data.phaseName} พลังชีวิตอาจขึ้นลงตามภาระ ควรลดการฝืนและเว้นช่วงพักให้เป็นกิจวัตร';
