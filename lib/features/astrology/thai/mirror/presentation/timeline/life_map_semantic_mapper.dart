      ...
      case LifeMapClaimDomain.relationshipBond:
        return _DomainPack(
          ...
          pressures: [
            _TextId(
              'prs_love',
              'ลองเทียบกับชีวิตจริงว่า ความคาดหวังที่ไม่ได้พูดทำให้ระยะห่างเพิ่มขึ้นหรือไม่',
            ),
            _TextId(
              'prs_love2',
      ...
      case LifeMapClaimDomain.familyHome:
        return _DomainPack(
          situations: [
            _TextId(
              'sit_home',
              'ช่วงนี้ชวนให้สังเกตว่า บรรยากาศในบ้านมีน้ำหนักต่อการตัดสินใจของคุณเพียงใด',
            ),
            _TextId(
              'sit_home2',
      ...
      case LifeMapClaimDomain.learningPath:
        return _DomainPack(
          ...
          pressures: [
            _TextId(
              'prs_learn',
              'ช่วงการเรียนรู้นี้อาจทำให้คุณไวต่อการเปรียบเทียบผลงาน จึงควรเทียบกับประสบการณ์จริง',
            ),
            _TextId(
              'prs_learn2',
      ...
      case LifeMapClaimDomain.opportunityExpand:
        return _DomainPack(
          situations: [
            _TextId(
              'sit_opp',
              'ธีมของช่วงนี้คือการเปิดรับโอกาสผ่านงานหรือเครือข่าย โดยใช้สิ่งที่เกิดขึ้นจริงเป็นตัวเทียบ',
            ),
            _TextId(
              'sit_opp2',
