...
abstract final class BaziReaderV2 {
  ...
  static const _relationshipPalaceCopy = <String, String>{
    '正印':
        'เมื่อคบจริง คุณต้องการความมั่นคง ความเข้าใจ และพื้นที่พักใจจากอีกฝ่าย',
    '偏印':
        'เมื่อคบจริง คุณต้องการคนที่เข้าใจวิธีคิดเฉพาะตัวและไม่บังคับให้ตอบสนองเหมือนคนทั่วไป',
    '比肩':
        'เมื่อคบจริง คุณต้องการความเท่าเทียมและพื้นที่ส่วนตัว ไม่ชอบให้ฝ่ายหนึ่งควบคุมทั้งหมด',
    '劫财':
        'เมื่อคบจริง ทั้งสองฝ่ายอาจเป็นคนมีจุดยืน จึงต้องตกลงเรื่องเงิน เวลา และอำนาจตัดสินใจ',
    '食神':
        'เมื่อคบจริง คุณให้ความสำคัญกับความสบายใจ การดูแลกัน และการพูดคุยที่ไม่กดดัน',
    '伤官':
        'เมื่อคบจริง คุณต้องการการสื่อสารตรงและอิสระ แต่ควรระวังคำพูดเร็วหรือแรงเกินเจตนา',
    '正财':
        'เมื่อคบจริง คุณมองความสม่ำเสมอและการรับผิดชอบในชีวิตประจำวันเป็นหลักฐานของความรัก',
    '偏财':
        'เมื่อคบจริง คุณให้ความสำคัญกับความยืดหยุ่น ประสบการณ์ร่วม และการเปิดโอกาสให้กัน',
    '正官':
        'เมื่อคบจริง คุณต้องการความชัดเจน ซื่อสัตย์ และข้อตกลงที่ทั้งสองฝ่ายรักษาได้',
    '七杀':
        'เมื่อคบจริง ความสัมพันธ์มักผลักให้เติบโตและตัดสินใจเร็ว จึงต้องระวังแรงกดดันหรือการคุมกันมากเกินไป',
  };
  ...
  static const _tenGodCycleCopy = <String, String>{
    ...
    '食神':
        'เป็นช่วงเปลี่ยนความรู้และประสบการณ์ให้กลายเป็นผลงานหรือรายได้ที่ทำซ้ำได้',
    '伤官':
        'เป็นช่วงรื้อวิธีเดิม พูดชัดขึ้น และสร้างสิ่งใหม่จากข้อจำกัดที่เคยรับไว้',
    ...
    '七杀':
        'เป็นช่วงที่โจทย์ยากและการแข่งขันผลักให้ตัดสินใจเร็วและเติบโตผ่านภาระจริง',
  };
  ...
  static const _tenGodAnnualCopy = <String, String>{
    ...
    '七杀':
        'ปีนี้แรงกดดันและเส้นตายเด่น เหมาะกับการผลักงานสำคัญให้จบ แต่ไม่ควรเปิดหลายแนวรบ',
  };
}
