  ...
  static ({String analysis, String guidance}) _composeHouseDomain(
    ...
    return switch (domain) {
      ThaiBirthProfileCoreDomain.work => (
        ...
        guidance:
            'งานจะเริ่มติดเมื่อ${mode.$2} ลอง${mode.$3} '
      ...
      ThaiBirthProfileCoreDomain.money => (
        ...
        guidance:
            'เรื่องเงินควรระวังเวลาที่${mode.$2} ก่อนตัดสินใจ ลอง${mode.$3} '
      ...
      ThaiBirthProfileCoreDomain.relationships => (
        ...
        guidance:
            'ความสัมพันธ์จะติดขัดเมื่อ${mode.$2} ลอง${mode.$3} '
      ...
      ThaiBirthProfileCoreDomain.wellbeing => (
        ...
        guidance:
            'ถ้าเริ่ม${mode.$2} อย่าปล่อยไว้นาน ลอง${mode.$3} '
  ...
  static ({String strength, String risk, String action}) _composeClosing(
    ...
    return (
      ...
      action: action.isEmpty
          ? ''
          : 'ลอง$action แล้วค่อยขยายเมื่อฐานเดิมรองรับได้',
    );
  }
