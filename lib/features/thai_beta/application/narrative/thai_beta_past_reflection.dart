    ...
    return switch (band) {
      ThaiBetaPastAgeBand.childhood => ThaiBetaPastReflection(
        ...
        theme:
            ...
            'ผู้ดูแล ความปลอดภัย การเรียนรู้ การเล่น และการได้รับการยอมรับ',
        question:
            'คำถามสะท้อน: เมื่อนึกถึงวัย $ageLabel คุณจำได้ไหมว่าที่ใดหรือใคร'
            'ทำให้กล้าลอง เล่น หรือเรียนรู้ และช่วงไหนที่ทำให้รู้สึกว่าตัวเองได้รับการยอมรับ',
      ),
      ThaiBetaPastAgeBand.adolescence => ThaiBetaPastReflection(
        ...
        question:
            ...
            'แยกสิ่งที่ตัวเองต้องการออกจากสิ่งที่คนรอบข้างคาด และการเลือกเล็ก ๆ ครั้งใดทำให้เห็นตัวตนชัดขึ้น',
      ),
      ThaiBetaPastAgeBand.emergingAdult => ThaiBetaPastReflection(
        ageBand: band,
        theme:
            'ธีมสำหรับทบทวน: $themeของ$phaseอยู่ในบริบทของการเป็นอิสระ '
            'การศึกษา การเริ่มงาน ความสัมพันธ์ และทรัพยากรที่ต้องจัดการเองมากขึ้น',
        question:
            'คำถามสะท้อน: เมื่อคิดถึงวัย $ageLabel คุณจำจุดใดได้ชัดที่สุด'
            'ระหว่างการออกไปยืนด้วยตัวเอง การเริ่มเส้นทางใหม่ หรือการตั้งขอบเขตกับคนใกล้ตัว',
      ),
      ThaiBetaPastAgeBand.adult => ThaiBetaPastReflection(
        ageBand: band,
        theme:
            'ธีมสำหรับทบทวน: ลองวาง$themeของ$phaseไว้ข้างงาน เงิน ความสัมพันธ์ '
            'ความรับผิดชอบ และบทบาทที่อาจต้องจัดใหม่',
        question:
            'คำถามสะท้อน: เมื่อมองกลับไปที่วัย $ageLabel มีความทรงจำช่วงใด'
            'ที่คุณต้องชั่งระหว่างสิ่งที่รับผิดชอบอยู่กับบทบาทที่อยากเปลี่ยน และอะไรช่วยให้ตัดสินใจในตอนนั้น',
      ),
    };
  }
}
