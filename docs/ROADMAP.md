...
| **Mirror Experience surfaces** | `docs/GLOBAL_MIRROR_EXPERIENCE_P3.md`, D-030 | Global Mirror Experience (P3) shipped over the Fusion Runtime (single provider today); localized Thai copy, richer per-provider phrasing, wiring the experience into HomePage navigation, and future providers/AI sharing the same card surface remain future work |
