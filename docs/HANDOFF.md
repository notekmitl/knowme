...
**Important:** Prefer `main`. Public Firebase Hosting was last deployed from `main` @ `f56b465` (2026-07-22) — Thai Beta Narrative **V1.2** + anonymous Public Beta at https://knowme-app-694e1.web.app/beta/thai (Thai landing, not Login; Evidence Badge remains `invited_beta`). Older feature branches such as `feature/fusion-result` remain useful historical snapshots; check [`CURRENT_STATUS.md`](CURRENT_STATUS.md) for the active deploy source.
