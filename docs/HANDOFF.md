...
**Important:** Prefer `main`. Public Firebase Hosting was last deployed from `main` @ `07d0eb9` (2026-07-23) — Thai Beta Report **Life Map V1.2.3** + **Mahabhut Canon-index fix** (PR #20) + anonymous Public Beta at https://knowme-app-694e1.web.app/beta/thai?v=07d0eb9 (Thai landing, not Login; Evidence Badge remains `invited_beta`). Older feature branches such as `feature/fusion-result` remain useful historical snapshots; check [`CURRENT_STATUS.md`](CURRENT_STATUS.md) for the active deploy source.
