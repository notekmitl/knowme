...
**Thai Beta Exemplar Narrative V1:** Recovered onto exact PR #82 HEAD `a20be549f8a25f529d539bb7f23734af469b8c50` as the third stacked layer (`PR #81 → PR #82 → Narrative`). It adds the deterministic summary/day-basis/chart-facts/domains/closing/omissions presentation shared by Web and PDF while retaining V3 and the repaired Required-suite contracts. Draft PR #83 HEAD `41684c6d1110b7e7358d79a78bf74425ca51327a` passed its Required suite and Gates. The local application-flow timeout was proved harness-only and a complete Web/PDF packet was generated, but Product Acceptance is **blocked**: synthetic unknown-time output presents the normalizer's assumed-noon path as “เวลาเกิดอยู่หลังพระอาทิตย์ขึ้น”, despite no birth time. The same condition exists on the PR #82 base. Draft candidate only; not merged, released, or deployed.
