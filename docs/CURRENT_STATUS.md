...
**Thai Beta Past-to-Future Narrative V3:** Recovered from the validated V3 archive and resumed on post-PR-80 main `3671b62fba86fc83365fdba597b695b1f3324c6b`. Validation is in progress; V3 is not a Production release. The standalone consumer golden remains a separate known failure.
