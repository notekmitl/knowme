...
**Branch:** `main`  
**Merge tip:** `ab093ad` (PR #25 — Life Map V1.2.6 narrative/life-stage UX); Production hosted @ `ab093ad`  
...
**Thai Beta Narrative / Life Map:** **V1.2.6** narrative clarity + life-stage UX deployed @ `ab093ad` (on top of V1.2.3–V1.2.5); status **Ready for Invited Beta Validation** (0 real Life Map Feedback). See [`THAI_LIFE_MAP_V126_NARRATIVE_UX.md`](THAI_LIFE_MAP_V126_NARRATIVE_UX.md).
...
| **Thai Life Map V1.2.6 Narrative & Life-stage UX** | Merged + **hosted** — **Ready for Validation** | PR #25 @ `ab093ad`; deploy Hosting 2026-07-23; age-aware Thai narrative; hide score charts + raw ดาวแทรก/ทักษา; Canon/formulas unchanged; [`THAI_LIFE_MAP_V126_NARRATIVE_UX.md`](THAI_LIFE_MAP_V126_NARRATIVE_UX.md) |
| **Thai Beta anonymous Public route** | Merged + **hosted + verified** | PRs #7–#8; re-verified with V1.2.6 deploy 2026-07-23 @ `ab093ad` |
...
| Hosting source vs `main` | **Low** | Public hosting last deployed from `main` @ `ab093ad` (2026-07-23); still **manual** only (`scripts/deploy_web.ps1`), no auto-deploy |
...
| Hosting source vs `main` | Low | Last public deploy from `main` @ `ab093ad` (manual); no auto-deploy | Keep using `scripts/deploy_web.ps1` for intentional releases |
...
| **Branch deployed from** | `main` @ `ab093ad` (2026-07-23); still **manual** deploy only — no auto-deploy |
