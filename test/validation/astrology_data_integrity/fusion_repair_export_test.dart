...
void main() {
  test(
    'exports fusion snapshot only when a complete repair batch is configured',
    () {
      ...
      expect(
        inputPath == null,
        outputPath == null,
        reason: 'FUSION_INPUT_PATH and FUSION_OUTPUT_PATH must be set together',
      );
      if (inputPath == null) return;

      final raw =
          jsonDecode(File(inputPath).readAsStringSync())
