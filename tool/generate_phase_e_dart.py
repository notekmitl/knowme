#!/usr/bin/env python3
"""Generate phase_e_prediction_units.dart from phase_e_prediction_units.json."""
...
OUT = ROOT / "test/validation/thai/generated/phase_e_prediction_units.dart"
...
STRENGTH = {
    "none": "AtomicStrength.none",
    "low": "AtomicStrength.low",
    "high": "AtomicStrength.high",
}
...
def main() -> None:
    ...
    for u in units:
        ...
        lines.append("        domain: KnowledgeDomain.lifePeriodRules,")
        lines.append(f"        strength: {STRENGTH.get(u.get('strength', 'none'), 'AtomicStrength.none')},")
        if u.get("condition"):
