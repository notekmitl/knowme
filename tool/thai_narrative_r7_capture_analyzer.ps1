...
$files = @(
  ...
  'test/validation/thai_beta/narrative/thai_beta_narrative_v15_r7_reader_quality_test.dart',
  'test/validation/thai_beta/narrative/thai_consumer_narrative_r7_canonical_text_test.dart',
