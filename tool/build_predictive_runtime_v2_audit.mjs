...
if (summary.counts.uniqueRepresentativeContextReports !== 49) errors.push('duplicate-context-report');
...
if (summary.status !== 'PASS_PREDICTIVE_RUNTIME_V2_OR1_PRODUCT_COVERAGE') errors.push(`status=${summary.status}`);
...
fs.writeFileSync('docs/PREDICTIVE_RUNTIME_V2_GENERALIZATION_AUDIT.md', `# Predictive Runtime V2 OR1 Product Coverage Audit
...
- Unsupported claims / fixture-specific branches / Known→Unknown leakage: ${summary.counts.unsupportedClaims} / ${summary.counts.fixtureSpecificBranches} / ${summary.counts.knownToUnknownLeakage}
- Unique representative normalized reports: ${summary.counts.uniqueRepresentativeContextReports}/49
